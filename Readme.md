...
A minimal, low-latency C++ logger using `mmap` and a background worker thread to avoid blocking the main execution.

### Features
* **Non-blocking:** The main thread pushes tasks to a queue. and a worker thread handles disk I/O.
